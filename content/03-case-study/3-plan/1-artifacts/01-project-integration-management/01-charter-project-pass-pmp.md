...
**Project PASS PMP** will consolidate all exam-relevant study material into a **single source of truth (SSoT)**: a structured, ECO-aligned study website authored in Obsidian, published with Quartz, and hosted on GitHub Pages. This site will provide an organized, navigable, and reliable study environment that removes the friction of managing multiple learning systems.
...
* All Links work and no dead ends.
*  Follow Bloomberg's Taxonomy to level 3 no page goes over level . Level4 45  are the reader o follow web.  Follow the 80 20 rule  80% over everything the reader needs to know is in the BLUF and the headers. 20% paragraphs:  Context 
