...
# 📘 Project Management Plan – Index

This index outlines the structure and purpose of each core component in the Project Management Plan repository. Each section maps to one of PMI’s ten Knowledge Areas and contains documents and templates that support proper planning, execution, monitoring, and closing of the project.

Each folder includes:
- A `README.md` for orientation and scope
- An `index.md` linking to all documents within that knowledge area
...
- [10 Scope Management](../10-scope-management/index.md)
- [20 Schedule Management](../20-schedule-management/index.md)
- [30 Cost Management](../30-cost-management-plan/index.md)
- [40 Quality Management](../40-quality-management-plan/index.md)
...
- [70 Risk Management](../70-risk-management-plan/index.md)
- [80 Procurement Management](../80-procurement-management-plan/index.md)
- [90 Stakeholder Management](../90-stakeholders/index.md)
